...
#ifndef SYSTEM_CALL_CODES
#define SYSTEM_CALL_CODES




#define SYSTEM_CALL_CODE_WRITE 0x01
#define SYSTEM_CALL_CODE_BRK 0x0c
#define SYSTEM_CALL_CODE_EXIT 0x3c
...
#if 0 /* Summary */
	+-----------+---------------------------+-----------+---------------------------------------+-------------------------------------------+-------------------------------------------+-----------------------------------+-------------------------------------------+---------------------------+-------------------------------------------+
	|	Number	|	Name					|	Rax		|	RDI									|	RSI										|	RDX										|	R10								|	R8										|	R9						|	Location in libc						|
	+-----------+---------------------------+-----------+---------------------------------------+-------------------------------------------+-------------------------------------------+-----------------------------------+-------------------------------------------+---------------------------+-------------------------------------------+
	...
	|	223		|	timer_settime			|	0xdf	|	timer_t timer_id					|	int flags								|	const struct itimerspec * new_settin	|	struct itimerspec * old_setting	|	-										|	-						|	kernel/posix-timers.c:819				|
